...
- group that judged accuracy of news headlines (yes it's true *OR* no it's false)
- group that were asked if they would share the headline online (yes *OR* no) 
...
# Calculate the proportion of 'yes' responses per participant for real headlines across both groups
realheadline <- study1 %>%
...
Similar to the scatterplots with analytical thinking, there is a weak positive correlation between belief in real headlines and science knowledge for the accuracy group. In contrast, there is a weak negative correlation between tendency to share real headlines and science knowledge. 

The regression lines for the real headlines reflect a different pattern to those for the fake headlines in which we see negative correlations for both groups. 
